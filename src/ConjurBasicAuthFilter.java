...
public class ConjurBasicAuthFilter implements Filter {
    /** Logger */
    private static final Logger logger = Logger.getLogger(ConjurBasicAuthFilter.class.getName());
                ...
                if (basic.equalsIgnoreCase("Basic")) {
                    try {
                        ...
                        if (p != -1) {
                            ...
                            String conjurApiKey=ConjurJava.authnLogin(_username, _password);
                            if (conjurApiKey == null) {
                              logger.log(Level.INFO, "Login failed.");
                            }
        		    String conjurAuthnResponse = ConjurJava.authenticate(_username, conjurApiKey);
