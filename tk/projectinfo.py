...
class ProjectInfo:
  ...
  def __init__(self, parent):
    ...
    ttk.Label(projectFrame, text="Vault Name").grid(column=0, row=2, sticky=W)
    self.vault = StringVar()
    self.vault_entry = ttk.Entry(projectFrame, width=15, textvariable=self.vault)
    self.vault_entry.grid(column=2, row=2, sticky=(W, E))

    ttk.Label(projectFrame, text="Safe Name").grid(column=0, row=3, sticky=W)
    self.safe = StringVar()
    self.safe_entry = ttk.Entry(projectFrame, width=15, textvariable=self.safe)
    self.safe_entry.grid(column=2, row=3, sticky=(W, E))

    ttk.Label(projectFrame, text="Requestor").grid(column=0, row=4, sticky=W)
    self.requestor = StringVar()
    requestor_entry = ttk.Entry(projectFrame, width=15, textvariable=self.requestor)
    requestor_entry.grid(column=2, row=4, sticky=(W, E))

    ttk.Label(projectFrame, text="Environment").grid(column=0, row=5, sticky=W)
    self.env = StringVar()
    ...
    envDev.grid(column=2, row=6, sticky=(W, E))
    envTest.grid(column=2, row=7, sticky=(W, E))
    envProd.grid(column=2, row=8, sticky=(W, E))
